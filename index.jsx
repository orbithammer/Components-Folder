      ...
      <div className="renders">
                ...
                {componentState === "Cards" && 
                  <>
                    ...
                    <div className="cards-wrapper">
                      <Card img="public/icons/cloud.svg" color="blue" title="Easy Deployment" >Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</Card>
                      <Card img="public/icons/tree.svg" color="green" title="Eco Friendly" >Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</Card>
                      <Card img="public/icons/house.svg" color="red" title="Time Sensitive Notifications" >Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</Card>
                      <Card img="public/icons/lemon.svg" color="yellow" title="High Quality" >Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</Card>
                    </div>
                  </>}
                {componentState === "Testimonials" && 
                  <>
                    ...
                    <Testimonial name="May Andersons" jobTitle="Workcation, CTO" img="public/images/portrait.webp">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed urna nulla vitae laoreet augue. Amet feugiat est integer dolor auctor adipiscing nunc urna, sit. </Testimonial>
                  </>}
                {componentState === "Home" && 
                  <>
                    <h1>Home</h1>
